    ...
    public class FocusManager : IFocusManager
    {
        ...
        private IEnumerable<int> GetNearbyControls ( Control control , bool checkTop = false , bool checkLeft = false )
        {
            ...
            for ( int i = 0 ; i < _controls . Length ; i++ )
            {
                ...
                //if ( control . Renderer . Boundary . Top == _controls [ i ] . Renderer . Boundary . Top && checkTop ||
                //	control . Renderer . Boundary . Left == _controls [ i ] . Renderer . Boundary . Left && checkLeft )
                //{
                //	yield return i ;
                //}
            }
